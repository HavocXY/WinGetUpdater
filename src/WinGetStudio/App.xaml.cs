...
public partial class App : Application
{
    private static readonly string CrashLog =
        Path.Combine(Path.GetTempPath(), "wingetstudio-crash.log");
    ...
    /// Aufruf: WinGetStudio.exe --selftest
    /// </summary>
    private static int RunSelfTest()
    {
        ...
        var target = Path.Combine(Path.GetTempPath(), "wingetstudio-selftest.txt");
